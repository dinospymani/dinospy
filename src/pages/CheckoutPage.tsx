      ...
      <main className="flex-grow pt-24 md:pt-40 pb-24 w-full">
        <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-12">
          <div className="mb-16 md:mb-24">
            <Link to="/cart" className="flex items-center text-black/30 hover:text-black transition-all mb-12 md:mb-20 group w-fit">
              ...
              <span className="text-[10px] uppercase tracking-[0.4em] font-mono font-bold">TERMINAL_VAULT // REVERSE</span>
            </Link>
            ...
            <div className="flex items-center justify-between max-w-xl mx-auto relative px-4 md:px-12">
              ...
              {[
                ...
                <div key={i} className="relative z-10 flex flex-col items-center">
                  ...
                  <span className={`text-[8px] md:text-[10px] uppercase tracking-[0.4em] mt-4 md:mt-8 font-mono font-bold ${step.active ? 'text-black' : 'text-black/10'}`}>{step.label}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 md:gap-24 items-start">
            ...
            >
              <div>
                <h1 className="text-5xl md:text-7xl xl:text-8xl font-display mb-6 text-black leading-none tracking-tightest font-medium">ACQUISITION<br /><span className="opacity-10 text-black italic">INITIALIZE.</span></h1>
                <p className="text-black/40 uppercase tracking-[0.4em] text-[10px] md:text-[12px] font-mono font-bold">Secure Checkout Terminal // Port_443_SSL</p>
              </div>

            <form onSubmit={handlePlaceOrder} className="space-y-8 lg:space-y-12">
              <div className="space-y-6 md:space-y-8">
                <h3 className="text-xl font-display font-medium tracking-tight uppercase flex items-center mb-10 border-b border-black/5 pb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                  <div className="space-y-3">
                    <label className="text-[10px] uppercase tracking-[0.4em] text-black/20 ml-1 font-mono font-bold">IDENTITY_MANIFEST</label>
                    <input 
                      required
                      value={formData.fullName}
                      onChange={e => setFormData({...formData, fullName: e.target.value})}
                      className="w-full bg-neutral-50 border border-black/5 rounded-[2rem] px-8 py-6 focus:border-black outline-none text-sm transition-all font-medium font-display tracking-tight"
                      placeholder="Full Name..."
                    />
                  </div>
                  <div className="space-y-3">
                    <label className="text-[10px] uppercase tracking-[0.4em] text-black/20 ml-1 font-mono font-bold">AUTH_EMAIL_PROTOCOL</label>
                    <input 
                      required
                      type="email"
                      value={formData.email}
                      onChange={e => setFormData({...formData, email: e.target.value})}
                      className="w-full bg-neutral-50 border border-black/5 rounded-[2rem] px-8 py-6 focus:border-black outline-none text-sm transition-all font-mono"
                ...
                <div className="space-y-12">
                  ...
                  <div className="space-y-3">
                    <label className="text-[10px] uppercase tracking-[0.4em] text-black/20 ml-1 font-mono font-bold">PHYSICAL_DROP_POINT</label>
                    <textarea 
                      required
                      value={formData.address}
                      onChange={e => setFormData({...formData, address: e.target.value})}
                      className="w-full bg-neutral-50 border border-black/5 rounded-[2rem] px-8 py-6 focus:border-black outline-none text-sm transition-all min-h-[120px] font-display tracking-tight"
                  ...
                  <div className="grid grid-cols-2 gap-8">
                    <div className="space-y-3">
                      <label className="text-[10px] uppercase tracking-[0.4em] text-black/20 ml-1 font-mono font-bold">CITY_NODE</label>
                      <input 
                        required
                        value={formData.city}
                        onChange={e => setFormData({...formData, city: e.target.value})}
                        className="w-full bg-neutral-50 border border-black/5 rounded-[2rem] px-8 py-6 focus:border-black outline-none text-sm transition-all font-display tracking-tight"
                        placeholder="City"
                      />
                    </div>
                    <div className="space-y-3">
                      <label className="text-[10px] uppercase tracking-[0.4em] text-black/20 ml-1 font-mono font-bold">TERRITORY</label>
                      <div className="w-full bg-neutral-100 border border-black/5 rounded-[2rem] px-8 py-6 text-sm text-black/40 font-display tracking-tight flex items-center justify-between cursor-not-allowed">
                        <span>INDIA</span>
              ...
              <div className="p-10 rounded-[3rem] bg-black text-white relative overflow-hidden group shadow-2xl">
                 ...
                 <div className="relative z-10">
                   <div className="flex items-center space-x-4 mb-8">
                      ...
                      <h4 className="text-xl font-display font-medium tracking-tight uppercase">Encryption <span className="opacity-40">Handshake</span></h4>
                   </div>
                   <p className="text-white/60 leading-relaxed text-sm font-display tracking-tight mb-8">
                   ...
                   <div className="flex items-center space-x-6">
                      <div className="px-5 py-2 rounded-full border border-white/20 bg-white/5 text-[9px] font-mono tracking-[0.3em] uppercase">
                        Protocol_Secure
                      </div>
                      <div className="px-5 py-2 rounded-full border border-white/20 bg-white/5 text-[9px] font-mono tracking-[0.3em] uppercase">
                        End_to_End
              ...
              <button 
                ...
                className={`w-full py-10 bg-black text-white rounded-[3rem] font-mono font-bold uppercase tracking-[0.8em] text-[11px] shadow-2xl transition-all duration-700 relative overflow-hidden group/btn ${isProcessing ? 'opacity-50 cursor-not-allowed' : 'hover:scale-[1.02] active:scale-[0.98]'}`}
              >
              ...
              <div className="flex items-center justify-center space-x-4 text-black/10">
                ...
                <span className="text-[10px] uppercase font-mono tracking-[0.6em] font-bold">Insured Protocol by DINOSPY_SEC</span>
              </div>
            </form>
          </motion.div>
            ...
            >
            <div className="bg-white border border-black/5 p-10 rounded-[4rem] shadow-xl sticky top-32 space-y-12 overflow-hidden relative">
              ...
              <div className="relative z-10">
                <div className="flex items-center justify-between mb-12">
                   <h2 className="text-sm font-mono font-bold uppercase tracking-[0.6em] text-black/20">MANIFEST_ARCHIVE</h2>
                    ...
                    <div key={item.id} className="flex space-x-6 items-center">
                      ...
                      <div className="flex-grow space-y-2">
                        ...
                        <div className="flex items-center justify-between">
                           <p className="text-[10px] text-black/20 font-mono font-bold uppercase tracking-widest">U_COUNT: {item.quantity}</p>
                           <span className="text-base font-mono font-bold">₹{Math.round(item.discount && (!item.offerExpiry || new Date(item.offerExpiry) > new Date()) ? item.price * (1 - item.discount / 100) : item.price).toLocaleString()}</span>
                        </div>
                      </div>
                    </div>
                  ))}
                ...
                <div className="space-y-6 pt-10 border-t border-black/5 relative">
                  ...
                  <div className="pb-10 border-b border-black/5">
                     <p className="text-[9px] uppercase tracking-[0.4em] text-black/20 mb-6 font-mono font-bold">PROMOTIONAL_KEY</p>
                     {coupon ? (
                        <div className="flex items-center justify-between bg-black text-white p-6 rounded-[2rem] shadow-xl group">
                           <div className="flex items-center space-x-4">
                              ...
                              <span className="text-sm font-mono font-bold uppercase tracking-[0.3em]">{coupon.code}</span>
                           </div>
                           <button onClick={removeCoupon} className="text-[10px] font-mono uppercase tracking-widest font-bold opacity-40 hover:opacity-100 transition-opacity">REVOKE</button>
                        </div>
                     ) : (
                        <div className="flex bg-neutral-50 border border-black/5 rounded-[2rem] p-1">
                           <input 
                             value={couponCode}
                             onChange={e => setCouponCode(e.target.value)}
                             placeholder="INPUT KEY..."
                             className="flex-grow bg-transparent px-6 py-4 outline-none text-xs uppercase tracking-[0.3em] font-mono"
                           />
                           <button 
                             onClick={handleApplyCoupon}
                             disabled={isValidatingCoupon || !couponCode}
                             className="px-8 bg-black text-white rounded-full text-[10px] font-mono font-bold uppercase tracking-widest disabled:opacity-20 transition-all active:scale-95 py-4"
                           >
                  ...
                  <div className="space-y-4">
                    <div className="flex justify-between items-center text-black/40">
                      <span className="text-[11px] uppercase tracking-[0.4em] font-mono font-bold">NET_VALUATION</span>
                      <span className="font-mono font-bold text-base">₹{subtotal.toLocaleString()}</span>
                    </div>
                    {savings > 0 && (
                      <div className="flex justify-between items-center text-black">
                        <span className="text-[11px] uppercase tracking-[0.4em] font-bold font-mono">ACQUISITION_GAINS</span>
                        <span className="font-mono font-bold text-base">-₹{savings.toLocaleString()}</span>
                      </div>
                    )}
                    <div className="flex justify-between items-center text-black/40">
                      <span className="text-[11px] uppercase tracking-[0.4em] font-mono font-bold">LOGISTICS_FEES</span>
                      <span className="font-mono font-bold uppercase tracking-[0.2em] px-3 py-1 bg-black/[0.05] rounded-full">NOMINAL_WAIVED</span>
                    </div>
                  </div>
