...
export default function WatchCard({ product }: WatchCardProps) {
  ...
  return (
    ...
    >
      ...
      <Link to={`/product/${product.id}`} className="block aspect-[4/5] mb-6 overflow-hidden rounded-lg bg-luxury-gray/50">
        <img 
      ...
      <div className="space-y-2">
        ...
        <div className="flex justify-between items-end pt-2">
          <div className="flex flex-col">
            ...
            <div className="text-xl font-mono text-gold/90">
          ...
          <motion.button 
            ...
            className="p-3 bg-white/5 hover:bg-gold hover:text-luxury-black rounded-full transition-all"
          >
            <ShoppingBag size={18} />
          </motion.button>
        </div>
