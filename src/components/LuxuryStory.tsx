...
export const LuxuryStory = () => {
  ...
  return (
    <section ref={container} className="py-40 bg-noir overflow-hidden">
        ...
        <div className="grid grid-cols-12 gap-12 items-center">
          <div className="col-span-12 lg:col-span-7">
             <div className="flex items-center space-x-6 mb-12 opacity-40">
                ...
                <span className="font-tech text-xs tracking-widest uppercase text-gold">THE_LEGACY // PHILOSOPHY</span>
             </div>
             
             <div className="flex flex-wrap gap-x-[0.3em] gap-y-0 text-5xl md:text-8xl font-display italic leading-[1.1] tracking-tightest">
                {words.map((word, i) => {
          ...
          <div className="col-span-12 lg:col-span-5">
             <div className="relative aspect-[3/4] rounded-[3rem] overflow-hidden group">
                ...
                <div className="absolute inset-24 border border-white/20 rounded-[2rem] group-hover:inset-12 transition-all duration-1000" />
             </div>
          </div>
        </div>
      </div>
